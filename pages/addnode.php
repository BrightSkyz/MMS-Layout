...
<div class="form-group">
   <label class="col-lg-2 control-label">Name the node</label>
   <input type="text" class="form-control" placeholder="Node Name (Ex, FRANCE/Node1)">
</div>
<div class="form-group">
   <label class="col-lg-2 control-label">Type the name of the user that will have the node.</label>
   <input type="text" class="form-control" placeholder="Username">
</div>
<div class="form-group">
   <label class="col-lg-2 control-label">Public IP of the node</label>
   <input type="text" class="form-control" placeholder="12.34.567.89">
</div>
<div class="form-group">
   <label class="col-lg-2 control-label">Type the code displayed when application is launched.</label>
   <input type="text" class="form-control" placeholder="ys73j93">
</div>
<div class="form-group">
   <label class="col-lg-2 control-label">Type the availible ports separated by commas. (No spaces!)</label>
